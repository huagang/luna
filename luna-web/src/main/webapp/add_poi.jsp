...
<body>
    <div class="container-fluid">
        ...
        <div id="add-poi" class="add-poi">
            ...
            <form:form id="poiModel" commandName="poiModel" method="post" action="${basePath}/add_poi.do?method=addPoi" enctype="multipart/form-data">
                <div>
                    <div class="item-poi">
				...
				<br>
                    ...
                    <div class="item-poi">
                        ...
                        <div class="value-poi">
                            <form:textarea id="description" path="briefIntroduction" cssClass="poi-des"/>
                        </div>
                    ...
                    <div class="item-poi">
                        ...
                        <div class="value-poi">
                            <form:input id="panorama" cssClass="txt" path="panorama" maxlength="32" placeholder="请输入全景页卡标识符或者场景点id"/>
                            <a href="#" style="margin-left: 8px;">全景编辑</a>
