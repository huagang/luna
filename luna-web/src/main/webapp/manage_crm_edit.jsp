                ...
                <form id="form-edit" action="<%=request.getContextPath() %>/content/crm/edit" method="post"
			        ...
			        <div class="information" >
						...
						<div class="item">
							...
							<div class="item-value">
								<input type="text" id="business-name-edit" name="business_name" placeholder="名称不超过32个字符" maxlength="32"/>
								<span id="warn-name-edit" class="red"></span>
							</div>
						</div>
						<div class="item">
							<div class="item-label"><span class="superscript">*</span>业务简称</div>
							<div class="item-value">
								<input type="text" id="business-name-short-edit" name="business_code" placeholder="英文简称不超过16个字符" maxlength="16"/>
								<span id="warn-short-edit" class="red"></span>
							</div>
						</div>
