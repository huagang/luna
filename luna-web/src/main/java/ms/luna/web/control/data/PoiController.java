...
public class PoiController extends BasicController {
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.GET, value = "/subTag/{subTag}")
    @ResponseBody
    public JSONObject ayncSearchSubTag(
            @PathVariable("subTag") Integer subTag,
    ...
    @ResponseBody
    public JSONObject asyncSearchPois(
        ...
        try {
            ...
            MsLogger.error(e);
            return FastJsonUtil.error("-1", "异常");
        }
    }

    @RequestMapping(method = RequestMethod.DELETE, value = "/{_id}")
    @ResponseBody
    public JSONObject asyncDeletePoi(
        ...
        try {
            ...
            MsLogger.debug(e);
            return FastJsonUtil.error("-1", "发生异常");
        }
    }
     ...
     * @throws IOException
     */
    @RequestMapping(method = RequestMethod.GET, value = "/checkPoiCanBeDeleteOrNot")
    @ResponseBody
    public JSONObject checkPoiCanBeDeleteOrNot(
            @RequestParam(required = true, value="_id") String _id,
            HttpServletRequest request, HttpServletResponse response) throws IOException {
     ...
     * Excel批量POI上传
     *
     * @param excel_fileup excel 文件
     * @param zip_fileup 资源压缩文件
     * @param request
     * @param response
     * @throws IOException
     */
    ...
    @ResponseBody
    public JSONObject asyncUploadPoisByExcel(
     ...
     * @throws IOException
     */
    @RequestMapping(method = RequestMethod.GET, value = "/templete")
    ...
    private Workbook generatePoiTemplete(JSONArray privateFieldsDef)
        ...
        Set<Map.Entry<String, List<JSONObject>>> entrySet = fieldsGroupByTagName.entrySet();
