...
public class LunaOrderGoods implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        LunaOrderGoods other = (LunaOrderGoods) that;
    ...
    public String toString() {
        return "LunaOrderGoods [id=" + id + ",goodsId=" + goodsId + ",categoryId=" + categoryId + ",goodsPrice=" + goodsPrice + ",goodsCount=" + goodsCount + ",extra=" + extra + ",updateTime=" + updateTime + ",createTime=" + createTime + "]";
    }
}