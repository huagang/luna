...
public class MsLogonLogCriteria {
    ...
    public MsLogonLogCriteria() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected MsLogonLogCriteria(MsLogonLogCriteria example) {
    ...
    public String toString() {
        return "MsLogonLogCriteria [orderByClause=" + orderByClause + ",distinct=" + distinct + ",oredCriteria=" + oredCriteria + "]";
    }
