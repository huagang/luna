...
public class LunaGoodsCategoryCriteria {
    ...
    public LunaGoodsCategoryCriteria() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected LunaGoodsCategoryCriteria(LunaGoodsCategoryCriteria example) {
    ...
    public String toString() {
        return "LunaGoodsCategoryCriteria [orderByClause=" + orderByClause + ",distinct=" + distinct + ",oredCriteria=" + oredCriteria + "]";
    }
