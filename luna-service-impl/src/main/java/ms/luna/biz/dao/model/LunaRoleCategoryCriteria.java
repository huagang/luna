...
public class LunaRoleCategoryCriteria {
    ...
    public LunaRoleCategoryCriteria() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected LunaRoleCategoryCriteria(LunaRoleCategoryCriteria example) {
    ...
    public String toString() {
        return "LunaRoleCategoryCriteria [orderByClause=" + orderByClause + ",distinct=" + distinct + ",oredCriteria=" + oredCriteria + "]";
    }
