...
public class RoomOtherInfo extends RoomOtherInfoKey implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        RoomOtherInfo other = (RoomOtherInfo) that;
    ...
    public String toString() {
        return "RoomOtherInfo [isSpecial=" + isSpecial + ",count=" + count + ",price=" + price + ",createTime=" + createTime + ",updateTime=" + updateTime + "->" + super.toString() + "]";
    }
}