...
public class RoomDynamicInfoCriteria {
    ...
    public RoomDynamicInfoCriteria() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected RoomDynamicInfoCriteria(RoomDynamicInfoCriteria example) {
    ...
    public String toString() {
        return "RoomDynamicInfoCriteria [orderByClause=" + orderByClause + ",distinct=" + distinct + ",oredCriteria=" + oredCriteria + "]";
    }
