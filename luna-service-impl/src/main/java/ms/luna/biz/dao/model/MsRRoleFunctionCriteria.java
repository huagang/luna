...
public class MsRRoleFunctionCriteria {
    ...
    public MsRRoleFunctionCriteria() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected MsRRoleFunctionCriteria(MsRRoleFunctionCriteria example) {
    ...
    public String toString() {
        return "MsRRoleFunctionCriteria [orderByClause=" + orderByClause + ",distinct=" + distinct + ",oredCriteria=" + oredCriteria + "]";
    }
