...
public class LunaRoleCriteria {
    ...
    public LunaRoleCriteria() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected LunaRoleCriteria(LunaRoleCriteria example) {
    ...
    public String toString() {
        return "LunaRoleCriteria [orderByClause=" + orderByClause + ",distinct=" + distinct + ",oredCriteria=" + oredCriteria + "]";
    }
