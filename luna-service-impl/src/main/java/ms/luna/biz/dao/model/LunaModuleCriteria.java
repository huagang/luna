...
public class LunaModuleCriteria {
    ...
    public LunaModuleCriteria() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected LunaModuleCriteria(LunaModuleCriteria example) {
    ...
    public String toString() {
        return "LunaModuleCriteria [orderByClause=" + orderByClause + ",distinct=" + distinct + ",oredCriteria=" + oredCriteria + "]";
    }
