...
public class LunaRoleMenuCriteria {
    ...
    public LunaRoleMenuCriteria() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected LunaRoleMenuCriteria(LunaRoleMenuCriteria example) {
    ...
    public String toString() {
        return "LunaRoleMenuCriteria [orderByClause=" + orderByClause + ",distinct=" + distinct + ",oredCriteria=" + oredCriteria + "]";
    }
