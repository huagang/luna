...
public class MsRTagFieldCriteria {
    ...
    public MsRTagFieldCriteria() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected MsRTagFieldCriteria(MsRTagFieldCriteria example) {
    ...
    public String toString() {
        return "MsRTagFieldCriteria [orderByClause=" + orderByClause + ",distinct=" + distinct + ",oredCriteria=" + oredCriteria + "]";
    }
