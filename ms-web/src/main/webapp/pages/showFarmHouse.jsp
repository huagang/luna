...
<head>
  ...
  <link rel="stylesheet" href="../resources/plugins/normalize/normalize.css"/>
  <link rel="stylesheet" href="../resources/styles/common.css">
  <link rel="stylesheet" href="../resources/styles/showFarmHouse.css">
...
<body ng-app="farmHouse"  ng-controller="FarmHouseController as farm">
    ...
    <div class="farmhouse-info">
        ...
        <nav>
            <div class="nav-item phone">
                <img class="img" src="../resources/images/farmhouse/phone.png"/>
                <p class="tip">电话预定</p>
            </div>
            <div class="nav-item navigation">
                <img class="img" src="../resources/images/farmhouse/navigation.png"/>
                <p class="tip">到这去</p>
            </div>
            <div class="nav-item pano">
                <img class='img' src="../resources/images/farmhouse/pano.png"/>
                <p class="tip">看全景</p>
            </div>
        </nav>
        <main>
    ...
    <script type='text/javascript' src='../resources/scripts/common/luna.config.js'></script>
    <script type='text/javascript' src='../resources/scripts/common/interface.js'></script>
    <script type="application/javascript" src="http://webapp.visualbusiness.cn/appengine/v1.0.26/libs/vbpano.js"></script>
    <script type='text/javascript' src='../resources/scripts/showFarmHouse.js'></script>
